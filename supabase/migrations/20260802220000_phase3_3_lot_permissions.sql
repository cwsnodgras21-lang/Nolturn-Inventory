-- Phase 3.3: lot permissions

insert into public.permissions (key, name, description, category) values
  ('inventory.lots.read', 'Read inventory lots', 'View lots, expiration, and lot history', 'inventory'),
  ('inventory.lots.manage', 'Manage inventory lots', 'Create and update lots and tracking settings', 'inventory')
...
where r.is_system = true
  ...
  and p.key in ('inventory.lots.read', 'inventory.lots.manage')
