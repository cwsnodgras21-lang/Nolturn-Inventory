-- Phase 2.6: inventory.reverse permission

insert into public.permissions (key, name, description, category) values
  ('inventory.reverse', 'Reverse inventory transactions', 'Reverse completed inventory transactions', 'inventory')
