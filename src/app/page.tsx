      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col justify-center gap-10 px-4 py-16 sm:px-8">
        <div className="space-y-5">
          ...
          <p className="max-w-2xl text-lg leading-relaxed text-muted">
            Secure multi-tenant inventory operations. Phase 2.4 establishes the immutable inventory
            ledger with opening balances and positive adjustments.
          </p>
        </div>
        ...
        <dl className="grid gap-6 border-t border-border pt-8 sm:grid-cols-3">
          <div>
            <dt className="text-sm font-medium text-foreground">Phase 2.4</dt>
            <dd className="mt-1 text-sm text-muted">
              Ledger foundation, balances, and positive adjustment workflow.
            </dd>
          </div>
          <div>
            <dt className="text-sm font-medium text-foreground">Not implemented</dt>
            <dd className="mt-1 text-sm text-muted">
              Receipts, consumption, transfers, reversals, purchasing, billing, and Nolt.
            </dd>
          </div>
          <div>
